...
import '../widgets/driver_map_widget_simple.dart';

class MapIntegratedDriverDashboard extends StatefulWidget {
  const MapIntegratedDriverDashboard({super.key});

  @override
  State<MapIntegratedDriverDashboard> createState() => _MapIntegratedDriverDashboardState();
}

class _MapIntegratedDriverDashboardState extends State<MapIntegratedDriverDashboard> {
            ...
            children: [
              ...
              IndexedStack(
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      DriverMapWidgetSimple(),
                      // MapControlsWidget(
                      //   onCenterLocation: _centerOnDriver,
                      //   onZoomIn: _zoomIn,
                      //   onZoomOut: _zoomOut,
                      // ),
...
// Reusing the existing dashboard pages from previous implementation
...
// Reusing other pages from previous implementation
