// lib/widgets/production_ready_map.dart
import 'dart:async';
...
class ProductionReadyMap extends StatefulWidget {
  ...
  @override
  State<ProductionReadyMap> createState() => _ProductionReadyMapState();
}

class _ProductionReadyMapState extends State<ProductionReadyMap> {
          ...
          children: [
            ...
            TileLayer(
              ...
              errorTileCallback: (tile, error, stackTrace) {
                if (error != null) {
                  _showErrorSnackBar('Map tile error: $error');
                }
                return true;
              },
            ),
...
// Simple Google Maps Directions API service
